...
const PROGRAMS = [
  {
    ...
    pairs: [
      {
        exercises: ['db-bench-press', 'cable-lateral-raise'],
        note: null
      },
      {
        exercises: ['incline-db-press', 'cable-tricep-pushdown'],
        note: 'Adjust bench to incline (30–45°) · Switch cable to high pulley + rope'
      },
      {
        exercises: ['cable-chest-fly', 'seated-db-shoulder-press'],
        note: 'Set bench upright (90°) · Cable to mid pulley for chest fly'
      }
    ]
  },
  {
    ...
    pairs: [
      {
        exercises: ['band-lat-pulldown', 'cable-face-pull'],
        note: 'Cable to high pulley + rope for face pull'
      },
      {
        exercises: ['cable-seated-row', 'cable-bicep-curl'],
        note: 'Mid pulley, close-grip for seated row · Low pulley, straight bar for curls'
      },
      {
        exercises: ['cable-single-arm-row', 'db-hammer-curl'],
        note: 'Mid pulley, D-handle for single-arm row'
      }
    ]
  },
  {
    ...
    pairs: [
      {
        exercises: ['db-goblet-squat', 'hanging-leg-raise'],
        note: null
      },
      {
        exercises: ['db-rdl', 'ab-knee-raise'],
        note: null
      },
      {
        exercises: ['cable-glute-kickback', 'dips'],
        note: 'Low pulley, ankle strap for glute kickback'
      }
    ]
  }
];
